...
import com.anurag.service.ServiceClass;
import com.anurag.service.ServiceInterface;
		...
		while (true) {
			...
			try {
				...
				case 4:
					...
					boolean b = service.checkcredentials(username3, password3);
					while (b == false) {
						...
						b = service.checkcredentials(username3, password3);
					}
